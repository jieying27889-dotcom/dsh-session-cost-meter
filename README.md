...
<p align="center">会话标题栏费用胶囊：显示本轮 / 累计 API 费用与 DeepSeek 账户余额，内置官方价格表与峰谷计价，可自定义计费标准。官方 bundle 插件，`dsh plugin --profile web add` 安装。</p>
...
| 标题栏胶囊 | `本轮 ¥x · 总计 ¥y · 余额 ¥z`，每轮回复后自动刷新 |
